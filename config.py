...
class Settings(BaseSettings):
    ...
    # Telegram
    # Railway often uses BOT_TOKEN; accept both
    TELEGRAM_BOT_TOKEN: Optional[str] = Field(default=None, validation_alias="BOT_TOKEN")
    ...
    def normalize_database_url(cls, v):
        """Force asyncpg driver when platform provides plain postgres URLs."""
